...
Interactive API docs: `http://localhost:8000/docs` and `http://localhost:8002/docs`
...
All examples assume the server is at `http://localhost:8000`. Replace with your actual host/port.
